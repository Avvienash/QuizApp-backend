...
// --- Load sample quiz for debug mode ---
...
async function generateQuizJSON(n = 10, rssUrl = "https://www.thestar.com.my/rss/News/", debug = false) {
  if (debug) {
...
app.get("/", (req, res) => res.send("✅ Quiz Generator API is running"));
...
export { generateQuizJSON };// --- Export for testing ---
